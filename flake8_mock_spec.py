...
PATCH_OBJECT_FUNCTION = (PATCH_FUNCTION, mock.patch.object.__name__.rsplit("_")[-1])
PATCH_OBJECT_MSG = PATCH_MSG_BASE % (
    PATCH_OBJECT_CODE,
    ".".join(PATCH_OBJECT_FUNCTION),
    PATCH_OBJECT_CODE.lower(),
)
PATCH_MULTIPLE_FUNCTION = (PATCH_FUNCTION, mock.patch.multiple.__name__.rsplit("_")[-1])
